...
3) Save the OpenPGP key from the [OpenPGP Keys for Open Job Description](#openpgp-keys-for-open-job-description) section above to a file called `openjobdescription-pgp.asc`.
